...
addpath('../funzioni_domanda_mazzoni/matrici_distanze');
costo = 1;
...
title(['Line of Separation, Victor Purpura, q =' num2str(0.001*costs(costo)) '/ms']);
...
avg_general = mean([avg_ch avg_rs avg_ib avg_fs]);
