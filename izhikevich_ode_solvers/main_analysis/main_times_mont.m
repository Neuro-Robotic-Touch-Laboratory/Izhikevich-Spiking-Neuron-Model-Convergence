...
addpath('../matrici_distanze_tempi/');
...
save(['../matrici_distanze_tempi/' title '.mat'],'correnti','costs','DISTANCES_rk1','DISTANCES_rk2','DISTANCES_rk4','lista_tau_rk1','lista_tau_rk2','lista_tau_rk4');